...
export function createSamosaCart(ownerName, location) {
  return {
    ...
    getDailySales() {
      ...
      const total = this.sales.reduce((a, e) => {
        return a + e.quantity * this.menu[e.item];
      }, 0);
      return total;
    },
    ...
    getPopularItem() {
      ...
      const highestSale = this.sales.sort((a, b) => {
        return b.quantity - a.quantity;
      });
      console.log(highestSale[0]);

      return highestSale[0].item;
    },
